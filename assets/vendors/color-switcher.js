...
$(document).ready(function () {
	...
	$(".default").click(function () {
		$("#red, #pink, #blue, #cyan, #purple, #green, #light-green, #yellow").css(
			"transform",
			"scale(1)"
		);
		rootAccess((n = 0));
	...
	// red color
	$("#red").click(function () {
		$("#pink, #blue, #cyan, #purple, #green, #light-green, #yellow").css(
			"transform",
			"scale(1)"
		);
		rootAccess((n = 1));
	...
	//pink-color
	$("#pink").click(function () {
		$("#red, #blue, #cyan, #purple, #green, #light-green, #yellow").css(
			"transform",
			"scale(1)"
		);
		rootAccess((n = 2));
	...
	// blue-color
	$("#blue").click(function () {
		$("#pink, #red, #cyan, #purple, #green, #light-green, #yellow").css(
			"transform",
			"scale(1)"
		);
		rootAccess((n = 3));
	...
	// cyan-color
	$("#cyan").click(function () {
		$("#pink, #blue, #red, #purple, #green, #light-green, #yellow").css(
			"transform",
			"scale(1)"
		);
		rootAccess((n = 4));
